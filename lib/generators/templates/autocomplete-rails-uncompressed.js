      ...
      $(e).autocomplete({
        ...
        select: function( event, ui ) {
          ...
          $(this).bind('keyup.clearId', function(){
						//Will not remove if removing only spaces
          ...
          return false;
			...
			// When using the id-element, it assumes that the
			// search box and the id-element will start in synch
			// so the id-element must be cleared
      $(e).bind('keyup.clearId', function(){
         $($(this).attr('data-id-element')).val("");
         $(this).unbind('keyup.clearId');
      });
